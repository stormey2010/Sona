...
WAKEWORD_COOLDOWN_SECONDS=$(value WAKEWORD_COOLDOWN_SECONDS)
WAKE_START_SOUND=$(value WAKE_START_SOUND)
WAKE_END_SOUND=$(value WAKE_END_SOUND)
TOOL_CALL_SOUND=$(value TOOL_CALL_SOUND)
...
sed -i 's|^TOOL_CALL_SOUND=$|TOOL_CALL_SOUND=assets/sounds/tool-call-notification.wav|' .env
sed -i 's/^ASSISTANT_NAME=$/ASSISTANT_NAME=Sona/; s/^WAKEWORD_COOLDOWN_SECONDS=$/WAKEWORD_COOLDOWN_SECONDS=3/' .env
